...
## Endpoints
REST API endpoint reference per module: HTTP method, path, auth requirement, request/response DTOs, purpose. Quick-reference summaries — for full request/response schemas, see `docs/openapi.json`.
